...
function Header() {
  return (
    <header className=" py-4 px-8 font-mono bg-emerald-900">
      <nav className="max-w-7xl mx-auto px-8 py-4 bg-violet-100 border flex justify-between items-center shadow-md rounded-lg backdrop-blur-lg ">
        {/* div for logo */}
        <div className="font-bebas text-3xl text-gray-800 font-bold tracking-wide">
          VINTNER
          </div>
        ...
        <div className="">
          <ul className='flex space-x-12'>
            ...
            <li>
              <NavLink to="/other" className={({isActive}) => `${isActive ? "text-red-900": "text-black"} hover:text-orange-700 duration-75 hover:font-bold`} >Github</NavLink>
            </li>
            <li>
              <NavLink to="/about" 
